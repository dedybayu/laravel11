    ...
    <body class="antialiased bg-gray-100 dark:bg-gray-900">
        ...
        {{-- <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="/../img/logo3.png" alt="mockup" class="w-32 max-w-xs object-contain">
            </div> 
            ...
            <div class="grid gap-8 lg:grid-cols-12 items-center">
                <div class="lg:col-span-6 text-center lg:text-left">
                    ...
                    <div class="flex justify-center lg:justify-start space-x-4">
                        <a href="/posts" class="inline-flex items-center px-5 py-3 text-base font-medium text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                            Back to Homepage
                            <svg class="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                            </svg>
                        </a>
                        <a href="/contact" class="inline-flex items-center px-5 py-3 text-base font-medium text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                            Hubungi kami
                        </a>
                    </div>
                </div>
                ...
                <div class="lg:col-span-6 hidden lg:flex justify-center">
                    <img src="/../img/logo3.png" alt="mockup" class="w-700 max-w-lg object-contain">
                </div> 
            </div>
        </div>
